...
public class PlayerEventHandlers implements CommonListenerInitializer {
    ...
    public static void onBlockDrop(final BlockDropEvent event) {
        ...
        if (entity instanceof PlayerEntity && event.getTool().getItem() == SoulboundItems.SOULBOUND_PICK && Components.TOOL_COMPONENT.get(entity).getStorage().hasSkill(ENDER_PULL)) {
...
*/
    ...
    public static void onPlayerTick(final PlayerTickEvent.Post event) {
        for (final SoulboundComponent component : Components.getComponents(event.getPlayer())) {
            component.tick();
        }
    }
