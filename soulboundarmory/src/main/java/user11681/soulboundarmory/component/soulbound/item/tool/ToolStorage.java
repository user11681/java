...
public abstract class ToolStorage<T extends ItemStorage<T>> extends ItemStorage<T> {
    ...
    public Text getMiningLevelName() {
        return this.getMiningLevelName((int) this.getAttribute(MINING_LEVEL));
    }

    public Text getMiningLevelName(final int level) {
        switch (level) {
            case 0:
                return Translations.MINING_LEVEL_COAL;
            case 1:
                return Translations.MINING_LEVEL_IRON;
            case 2:
                return Translations.MINING_LEVEL_DIAMOND;
            case 3:
                return Translations.MINING_LEVEL_OBSIDIAN;
        }
    ...
    public List<ScreenTab> getTabs() {
        ...
        tabs.add(new SelectionTab(Translations.MENU_TOOL_SELECTION, this.component, tabs));
