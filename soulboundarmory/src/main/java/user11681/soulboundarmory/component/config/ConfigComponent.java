...
public class ConfigComponent implements AutoSyncedComponent {
    ...
    public void readFromNbt(final CompoundTag tag) {
        SoulboundArmoryClient.PACKET_REGISTRY.sendToServer(Packets.C2S_CONFIG, new ExtendedPacketBuffer().writeBoolean(this.addToOffhand).writeBoolean(this.levelupNotifications));
    }
