...
public class AnnotationHierarchy extends Object2ReferenceOpenHashMap<String, JsonAnnotationType> {
    ...
    public ReferenceArrayList<AnnotationContext> getAnnotations(final Class<?> type) {
        return this.annotationTypes.get(type.getName());
    }
    ...
    public static AnnotationHierarchy read() {
        try {
            ...
            final Enumeration<URL> annotationFiles = UnsafeKnotClassLoader.instance.getResources("projectfabrok-annotations.json");
